-- ============================================================================
-- Migration: Add Audit Platform Tables (Final - Idempotent)
-- Version: 20251130120008
-- Description: Creates audit tables using firms table, handles existing objects
-- ============================================================================

-- Drop existing tables and policies to start clean
DROP POLICY IF EXISTS "Users can manage audit templates" ON public.audit_templates;
DROP POLICY IF EXISTS "Users can manage audit documents" ON public.audit_documents;
DROP POLICY IF EXISTS "Users can manage strategy memos" ON public.audit_strategy_memos;
DROP POLICY IF EXISTS "Users can manage audit reports" ON public.audit_reports;
DROP POLICY IF EXISTS "Users can manage signoffs" ON public.signoffs;
DROP POLICY IF EXISTS "Users can manage review notes" ON public.review_notes;
DROP POLICY IF EXISTS "Users can manage findings" ON public.audit_findings;
DROP POLICY IF EXISTS "Users can manage adjustments" ON public.audit_adjustments;
DROP POLICY IF EXISTS "Users can manage analytical procedures" ON public.analytical_procedures;
DROP POLICY IF EXISTS "Users can manage confirmations" ON public.confirmations;
DROP POLICY IF EXISTS "Users can manage sampling" ON public.sampling_plans;
DROP POLICY IF EXISTS "Users can manage materiality" ON public.materiality_calculations;
DROP POLICY IF EXISTS "Users can manage audit procedures" ON public.audit_procedures;
DROP POLICY IF EXISTS "Users can manage audit programs" ON public.audit_programs;
DROP POLICY IF EXISTS "Users can manage risk assessments" ON public.risk_assessments;
DROP POLICY IF EXISTS "Users can manage their firm engagements" ON public.engagements;
DROP POLICY IF EXISTS "Users can view their firm engagements" ON public.engagements;
