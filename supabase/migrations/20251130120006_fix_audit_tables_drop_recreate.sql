-- ============================================================================
-- Migration: Fix Audit Platform Tables (Drop and Recreate)
-- Version: 20251130120006
-- Description: Drops any existing broken tables and creates correct audit tables
-- ============================================================================

-- Drop existing tables if they have wrong schema (from broken migration)
...
CREATE INDEX idx_engagements_organization ON public.engagements(organization_id);
...
CREATE INDEX idx_audit_templates_organization ON public.audit_templates(organization_id);
