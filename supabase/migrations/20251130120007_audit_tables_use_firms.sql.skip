-- ============================================================================
-- Migration: Add Audit Platform Tables (Using firms table)
-- Version: 20251130120007
-- Description: Creates audit tables referencing firms (organizations is a view)
-- ============================================================================

-- Note: organizations is a VIEW that maps to firms table
-- Foreign keys must reference the actual table (firms), not the view

-- Drop existing tables if they exist from broken migrations
...
-- Don't drop clients - it already exists with firm_id
