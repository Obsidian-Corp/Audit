-- ============================================================================
-- Migration: Add Audit Platform Tables (Correct RLS using existing functions)
-- Version: 20251130120005
-- Description: Adds audit-specific tables using is_org_member() function
-- Dependencies: public.is_org_member() function (already exists)
-- ============================================================================
...
CREATE POLICY "Users can view their org clients"
...
CREATE INDEX IF NOT EXISTS idx_engagements_organization ON public.engagements(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_engagements_partner ON public.engagements(engagement_partner_id);
ALTER TABLE public.engagements ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can view their org engagements"
  ON public.engagements FOR SELECT
  TO authenticated
  USING (public.is_org_member(auth.uid(), organization_id));

CREATE POLICY "Users can manage their org engagements"
...
CREATE INDEX IF NOT EXISTS idx_risk_assessments_engagement ON public.risk_assessments(engagement_id);
CREATE INDEX IF NOT EXISTS idx_risk_assessments_combined_risk ON public.risk_assessments(combined_risk);
...
CREATE INDEX IF NOT EXISTS idx_audit_programs_engagement ON public.audit_programs(engagement_id);
ALTER TABLE public.audit_programs ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage audit programs"
...
CREATE INDEX IF NOT EXISTS idx_audit_procedures_program ON public.audit_procedures(program_id);
CREATE INDEX IF NOT EXISTS idx_audit_procedures_assigned ON public.audit_procedures(assigned_to);
CREATE INDEX IF NOT EXISTS idx_audit_procedures_status ON public.audit_procedures(status);
ALTER TABLE public.audit_procedures ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage audit procedures"
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS public.materiality_calculations (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  organization_id UUID NOT NULL REFERENCES public.organizations(id) ON DELETE CASCADE,
  engagement_id UUID NOT NULL REFERENCES public.engagements(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_materiality_engagement ON public.materiality_calculations(engagement_id);
ALTER TABLE public.materiality_calculations ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage materiality"
  ON public.materiality_calculations FOR ALL
  TO authenticated
  USING (public.is_org_member(auth.uid(), organization_id));
...
CREATE INDEX IF NOT EXISTS idx_sampling_engagement ON public.sampling_plans(engagement_id);
CREATE INDEX IF NOT EXISTS idx_sampling_procedure ON public.sampling_plans(procedure_id);
ALTER TABLE public.sampling_plans ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage sampling"
  ON public.sampling_plans FOR ALL
  TO authenticated
  USING (public.is_org_member(auth.uid(), organization_id));
...
CREATE INDEX IF NOT EXISTS idx_confirmations_engagement ON public.confirmations(engagement_id);
CREATE INDEX IF NOT EXISTS idx_confirmations_status ON public.confirmations(status);
CREATE INDEX IF NOT EXISTS idx_confirmations_type ON public.confirmations(confirmation_type);
ALTER TABLE public.confirmations ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage confirmations"
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS public.analytical_procedures (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  organization_id UUID NOT NULL REFERENCES public.organizations(id) ON DELETE CASCADE,
  engagement_id UUID NOT NULL REFERENCES public.engagements(id) ON DELETE CASCADE,
  account_area TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_analytical_engagement ON public.analytical_procedures(engagement_id);
CREATE INDEX IF NOT EXISTS idx_analytical_threshold ON public.analytical_procedures(exceeds_threshold);
ALTER TABLE public.analytical_procedures ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage analytical procedures"
  ON public.analytical_procedures FOR ALL
  TO authenticated
  USING (public.is_org_member(auth.uid(), organization_id));
...
CREATE INDEX IF NOT EXISTS idx_adjustments_engagement ON public.audit_adjustments(engagement_id);
CREATE INDEX IF NOT EXISTS idx_adjustments_type ON public.audit_adjustments(adjustment_type);
CREATE INDEX IF NOT EXISTS idx_adjustments_posted ON public.audit_adjustments(posted);
ALTER TABLE public.audit_adjustments ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage adjustments"
  ON public.audit_adjustments FOR ALL
  TO authenticated
  USING (public.is_org_member(auth.uid(), organization_id));
...
CREATE INDEX IF NOT EXISTS idx_findings_engagement ON public.audit_findings(engagement_id);
CREATE INDEX IF NOT EXISTS idx_findings_severity ON public.audit_findings(severity);
CREATE INDEX IF NOT EXISTS idx_findings_status ON public.audit_findings(status);
...
CREATE INDEX IF NOT EXISTS idx_review_notes_engagement ON public.review_notes(engagement_id);
CREATE INDEX IF NOT EXISTS idx_review_notes_status ON public.review_notes(status);
CREATE INDEX IF NOT EXISTS idx_review_notes_created_by ON public.review_notes(created_by);
ALTER TABLE public.review_notes ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage review notes"
...
CREATE INDEX IF NOT EXISTS idx_signoffs_engagement ON public.signoffs(engagement_id);
CREATE INDEX IF NOT EXISTS idx_signoffs_entity ON public.signoffs(entity_id);
CREATE INDEX IF NOT EXISTS idx_signoffs_signed_by ON public.signoffs(signed_by);
ALTER TABLE public.signoffs ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage signoffs"
...
CREATE INDEX IF NOT EXISTS idx_audit_reports_engagement ON public.audit_reports(engagement_id);
CREATE INDEX IF NOT EXISTS idx_audit_reports_final ON public.audit_reports(is_final);
ALTER TABLE public.audit_reports ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage audit reports"
...
-- ============================================================================
CREATE TABLE IF NOT EXISTS public.audit_strategy_memos (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  organization_id UUID NOT NULL REFERENCES public.organizations(id) ON DELETE CASCADE,
  engagement_id UUID NOT NULL REFERENCES public.engagements(id) ON DELETE CASCADE,
...
CREATE INDEX IF NOT EXISTS idx_strategy_memos_engagement ON public.audit_strategy_memos(engagement_id);
ALTER TABLE public.audit_strategy_memos ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage strategy memos"
  ON public.audit_strategy_memos FOR ALL
  TO authenticated
  USING (public.is_org_member(auth.uid(), organization_id));
...
CREATE INDEX IF NOT EXISTS idx_audit_documents_engagement ON public.audit_documents(engagement_id);
CREATE INDEX IF NOT EXISTS idx_audit_documents_procedure ON public.audit_documents(procedure_id);
ALTER TABLE public.audit_documents ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage audit documents"
...
CREATE INDEX IF NOT EXISTS idx_audit_templates_organization ON public.audit_templates(organization_id);
CREATE INDEX IF NOT EXISTS idx_audit_templates_type ON public.audit_templates(template_type);
ALTER TABLE public.audit_templates ENABLE ROW LEVEL SECURITY;

CREATE POLICY "Users can manage audit templates"
