...
const USERS = {
  partner: 'e91826d7-e169-4d52-905e-55d486d98512',
  manager: '195e2ebf-1fc6-4c36-a18a-71c5e0056e2e',
  staff: 'c03baf8f-c5ff-446b-8e28-401f9464abc7',
  demo: '950005d5-41d5-4f83-bf0b-efe32be1f055'
};

const AUDITS = {
  healthcare: '4f161f98-41ce-4682-bf7d-26afe0468e28',
  compliance: 'a52edabd-b721-46d5-b44f-195dffe115b7',
  itSecurity: '506082bf-b84a-471a-8537-ab2977406aac'
};

async function seedEngagementDocuments() {
  console.log('Seeding engagement_documents (evidence)...');
  
  // Valid document_type: 'contract', 'proposal', 'scope', 'correspondence', 'workpaper', 'supporting', 'other'
  const documents = [
    // Healthcare Plus Evidence
    {
      ...
      file_url: '/evidence/healthcare-plus/bank-statement-operating-dec24.pdf',
      file_size: 245678,
    ...
    },
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/healthcare-plus/bank-statement-payroll-dec24.pdf',
      file_size: 156789,
      tags: ['bank', 'payroll', 'december'],
      uploaded_by: USERS.staff,
      category: 'bank_confirmation'
    },
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/healthcare-plus/ar-aging-12312024.xlsx',
      file_size: 89234,
    ...
    },
    {
      ...
      file_url: '/evidence/healthcare-plus/revenue-analysis.xlsx',
      file_size: 234567,
    ...
    },
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/healthcare-plus/gl-trial-balance.pdf',
      file_size: 567890,
      tags: ['general-ledger', 'trial-balance'],
      uploaded_by: USERS.staff,
    ...
    },
    {
      ...
      file_url: '/evidence/healthcare-plus/legal-confirmation.pdf',
      file_size: 123456,
    ...
    // IT Security Assessment Evidence
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/retail-dynamics/user-access-erp.xlsx',
      file_size: 456789,
      tags: ['access', 'ERP', 'security'],
      uploaded_by: USERS.demo,
    ...
    },
    {
      ...
      document_type: 'workpaper',
      file_url: '/evidence/retail-dynamics/privileged-access-review.pdf',
      file_size: 234567,
      tags: ['privileged', 'access', 'admin'],
      uploaded_by: USERS.demo,
      category: 'it_controls'
    },
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/retail-dynamics/change-tickets-q3.pdf',
      file_size: 789012,
      tags: ['change-management', 'tickets'],
      uploaded_by: USERS.staff,
      category: 'it_controls'
    },
    {
      ...
      document_type: 'other',
      file_url: '/evidence/retail-dynamics/network-diagram.pdf',
      file_size: 1234567,
    ...
    // Green Energy Compliance Evidence
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/green-energy/epa-permit-2024.pdf',
      file_size: 345678,
    ...
    },
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/green-energy/emissions-q3-2024.pdf',
      file_size: 234567,
    ...
    },
    {
      ...
      document_type: 'supporting',
      file_url: '/evidence/green-energy/safety-inspection-aug24.pdf',
      file_size: 456789,
  ...
  if (error) {
    console.error('Error seeding engagement documents:', error);
  } else {
    console.log(`✓ Seeded ${data.length} engagement documents (evidence)`);
  }
}
...
async function seedInformationRequests() {
  ...
  const requests = [
    ...
    },
    {
      ...
      response_date: '2025-01-08T14:30:00Z'
    },
    {
      engagement_id: AUDITS.healthcare,
    ...
    // IT Security Assessment Requests
    {
      ...
      response_date: '2024-08-14T16:45:00Z'
    },
    {
      engagement_id: AUDITS.itSecurity,
      ...
      response_date: '2024-08-19T11:20:00Z'
    },
    ...
    // Green Energy Compliance Requests
    {
      ...
      response_date: '2024-09-12T09:15:00Z'
    },
    {
      engagement_id: AUDITS.compliance,
...
async function main() {
  console.log('=== Seeding Audit Execution Final Data ===\n');
  
  await seedEngagementDocuments();
